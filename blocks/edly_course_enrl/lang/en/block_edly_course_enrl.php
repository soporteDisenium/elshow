<?php
$string['pluginname'] = '[Edly] Course Enrolment Custom';
$string['edly_course_enrl'] = '[Edly] Course Enrolment Custom';
$string['edly_course_enrl:addinstance'] = 'Add a new course Enrolment Custom block';
$string['edly_course_enrl:myaddinstance'] = 'Course Enrolment Custom block';
